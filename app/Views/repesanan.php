        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" align="center">Restore Pesanan</h4>
                </div>
   ...
   document.addEventListener("DOMContentLoaded", function () {
    ...
    deleteButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            if (confirm('restore pesanan dengan kode: ' + kodePesanan + '?')) {
                // Lakukan penghapusan data, misalnya dengan AJAX atau mengarahkan ke URL penghapusan
              window.location.href = '<?= base_url("home/aksirepesanan/") ?>/' + kodePesanan;
